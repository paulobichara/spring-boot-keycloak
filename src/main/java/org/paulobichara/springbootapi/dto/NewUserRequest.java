...
public record NewUserRequest(@NotBlank(message = "{validation.user.firstName.notBlank}") String firstName,
                             ...
                             @NotBlank(message = "{validation.user.username.notBlank}") String username,
